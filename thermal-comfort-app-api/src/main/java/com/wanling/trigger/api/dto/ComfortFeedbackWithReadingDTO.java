...
@Builder
public record ComfortFeedbackWithReadingDTO(
        ...
        @JsonProperty("location_display_name")
        String locationDisplayName,

        @JsonProperty("is_custom_location")
        ...
        @JsonProperty("clothing_level")
        String clothingLevel,

        @JsonProperty("adjusted_temp_level")
        Integer adjustedTempLevel,

        @JsonProperty("adjusted_humid_level")
